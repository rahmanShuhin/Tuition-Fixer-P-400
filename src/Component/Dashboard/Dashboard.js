<<<<<<< HEAD:src/Component/Dashboard/Dashboard.js
  ...
  return (
    <div className="dashboard">
      ...
      <div>
        <div>
          <Button
            className={step === 1 && "dashboard_active"}
          ...
          <Button
            onClick={handleJobs}
            className={step === 2 && "dashboard_active"}
          >
            Tuition Request
          </Button>
          <Button
            className={step === 3 && "dashboard_active"}
            ...
            <div>
              ...
              <div class="tbl-content">
                <table cellpadding="0" cellspacing="0" border="0">
                  <tbody>
                    {contact.length !== 0 &&
                      contact.map((x) => <DashContact x={x}></DashContact>)}
                  </tbody>
                </table>
              </div>
            </div>
...
export default Dashboard;
>>>>>>> 9f2daa89ffaf066a16c7fb6fdd260f9f7c645596:src/Components/Dashboard/Dashboard.js
